 ...
 */
final class Version20230531164641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, phone VARCHAR(180) NOT NULL, email VARCHAR(180) DEFAULT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_C7440455444F97DD (phone), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tours (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, title VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, price INT UNSIGNED DEFAULT 0 NOT NULL, long_time VARCHAR(255) DEFAULT NULL, complexity VARCHAR(255) DEFAULT NULL, group_size INT UNSIGNED DEFAULT NULL, details JSON DEFAULT NULL, key_words VARCHAR(255) DEFAULT NULL, created_at INT UNSIGNED NOT NULL, public TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
